...
> **[🚀 Baixar Instalador OdontOC - v1.0.0 (Windows .exe)](#)** *(Link em breve)*
...
### Versões Disponíveis:
- 🟢 **v1.0.1 (Mais Recente)** - *Melhorias no Odontograma, salvamento automático e aba de Configurações.* -> **[Baixar Update v1.0.1](#)**
- ⚪ **v1.0.0** - *Lançamento inicial do sistema.*
